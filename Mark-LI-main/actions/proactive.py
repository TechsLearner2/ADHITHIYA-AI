...
The LLM decides what to say; this module decides WHEN and builds a rich context snapshot.
"""
import time
...
class ProactiveEngine:
    """
    Decides when ADHITHIYA should speak unprompted and builds a context-rich prompt.
    ...
    Improvements over 1.0:
      ...
      - Smarter silence gate    (doesn't fire while ADHITHIYA is speaking)
    ...
    def build_prompt(
        ...
        """
        Build a context snapshot for the LLM.
